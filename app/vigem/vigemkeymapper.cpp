...
VigemKeyMapper VigemKeyMapper::createDefault()
{
    ...
    mapper.keyMap[ButtonStart] = Qt::Key_T;
    mapper.keyMap[ButtonBack] = Qt::Key_R;
    mapper.keyMap[ButtonLThumb] = Qt::Key_Q;
    mapper.keyMap[ButtonRThumb] = Qt::Key_Home;
    ...
    mapper.keyMap[ButtonRThumbRight] = Qt::Key_PageUp;
    mapper.keyMap[ButtonRThumbUp] = Qt::Key_Home;
    mapper.keyMap[ButtonRThumbDown] = Qt::Key_End;
    mapper.keyMap[ButtonStartup] = Qt::Key_G;
